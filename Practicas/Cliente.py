...
def hilo():													#función que se encarga de recibir las datos del servidor
	while True:												
		...
		if data[0] == 49:									#Verifica que es el comienzo de una nueva imagen
			guardadas = "/home/emiliano/Escritorio/Broadcast/guardadas/" + name_img
			f = open(guardadas, "wb")						#Abro un archivo con el nombre de name_img
			...
			while True:										
				...
				if data[0] == 50:							#Verifica que son datos intermedios de la imagen
					...
					with open(guardadas, "rb") as f:			#Vulevo a abrir el archivo
